...
export const distros = pgTable('distros', {
	...
	defaultDesktopEnvironment: desktopEnvironmentEnum('default_desktop_environment').notNull(),
	supportedDesktopEnvironments: desktopEnvironmentEnum('supported_desktop_environments')
		.array()
		.notNull(),
...
export const sessions = pgTable('sessions', {
	// Opaque random token — this is the same value stored in the session cookie.
	id: text().primaryKey(),
	userId: uuid('user_id')
		.notNull()
